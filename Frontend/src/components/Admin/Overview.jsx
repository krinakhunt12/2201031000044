        ...
        <div className="bg-white p-5 rounded-xl border border-gray-100 shadow-xs lg:col-span-2">
          <div className="flex items-center justify-between mb-5">
            ...
            <div className="flex space-x-2">
              <button className="px-3 py-1.5 text-xs font-medium bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors">
                Week
              </button>
              <button className="px-3 py-1.5 text-xs font-medium bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors">
                Month
              </button>
              <button className="px-3 py-1.5 text-xs font-medium bg-blue-600 text-white hover:bg-blue-700 rounded-lg transition-colors">
                Year
              </button>
            </div>
          </div>
          <div className="h-72 bg-gray-50 rounded-lg flex items-center justify-center border border-gray-200">
