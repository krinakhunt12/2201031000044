...
const FeaturedProducts = () => {
  ...
  const products = [
    ...
    { 
      ...
      rating: 4.9, 
      originalPrice: null,
      image: "./products/latherJacket.png",
      category: "Outerwear",
    ...
    },
{
  ...
  category: "Clothing",
  description: "Stylish and versatile denim jacket perfect for layering.",
  colors: ["#1C1C1C", "#2E86C1", "#F5F5F5"],
  sizes: ["S", "M", "L", "XL", "XXL"],
  isNew: true,
  isBestSeller: false,
  reviews: 178,
